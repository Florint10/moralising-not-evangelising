...
Hence, it could be argued that this action was not intended by the Altruist, or even Alum, as evidenced by his shock when he realises that he killed Glymm. In this way, the scripted narrative could still be said to disapprove of his actions. However, for \textcite{innuendo_studios_co-vids_2020}, Alum's homicide points to a broader pattern which justifies brutality in the name of God, along with the other aggressive acts Alum and the Rogations commit (e.g., the murder of an ice giant, breaking into the Kozmos City wall using explosives, etc.).
