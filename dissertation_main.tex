...
\title{Moralising, not\\Evangelising}  % use \\ here otherwise you get a justified title
                                     % note capitalization of the title (only common 
                                     % words in lower case)
\tagline{An exploration of Explicitly\\Christian game design, common\\ issues, and potential solutions.}
                                     % tag line
