...
\title{Perceived Vice and \\Unengaging Edification}  % use \\ here otherwise you get a justified title
                                     % note capitalization of the title (only common 
                                     % words in lower case)
\tagline{Game Analyses of Two Christian Digital Games.}
                                     % tag line
...
\addbibresource{chap3/methodology_biblio.bib}
...
\frontmatter 
    ...
    \includepdf[pages=-]{frontmatter/authenticityform.pdf}
